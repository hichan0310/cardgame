...
3. 보스
   1. 기사단장
      ...
      - 필살기 : 수호신의 방패
        ...
        - 3턴간 딜 -> 2턴간 무적 -> 1턴간 딜 -> 2턴간 무적 반복
        - 이 스킬로 인하여 강력한 관통 데미지가 아니라면 피해를 줄 수 없다.
        - 루시퍼, 기드온처럼 버프를 몰아주고 한번에 터트리는 캐릭터가 딜을 잘 넣는다. 
      - 발악 패턴
   ...
   2. 무법자
      ...
      - 일반 공격 : 난사
        - 적 2명에게 3의 피해를 가한다.
      - 스킬 : 방어막 전개
        - 자신에게 방어막을 두른다. 이 상태에서 피해를 받으면 절반의 피해를 상대방에게 가한다. 
        - 이 버프는 2번의 스킬 피해를 받아야 없어진다. 
        - 이 스킬을 사용하고 다음 턴에 필살기 유도탄을 사용한다. 
      - 필살기 : 유도탄
        - 여섯 방향으로 유도탄을 날린다. 유도탄은 적 1명을 자동으로 추적한다. 
        - 유도탄 하나는 각각 3의 피해를 준다. 
        - 이 스킬은 방어막이 있는 경우에만 발동된다. 
